...
const mapStateToProps = ( state ) => {
    ...
    // Use productsByWarehouse when available, fallback to products
    const currentProducts = products.productsByWarehouse && products.productsByWarehouse.length > 0 ? products.productsByWarehouse : products.products || [];
    return { customProducts: prepareSaleProductArray( currentProducts ), purchaseProducts, products: currentProducts, frontSetting, allConfigData }
}
