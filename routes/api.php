...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('get-last-sale-price/{productId}/{customerId}', [SaleAPIController::class, 'getLastSalePriceForCustomer']);
    Route::get('debug-last-sale-price/{productId}/{customerId}', [SaleAPIController::class, 'debugLastSalePrice']);
